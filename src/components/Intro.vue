...
<style scoped lang="scss">
    .intro_box{
        padding: clamp(2rem, 4.5vw, 4.5rem) clamp(1.25rem, 4.8vw, 3.75rem);
    }
    ...
    .intro_text::before {
        ...
        width: 120px;
        height: 100%;
        background-image: url('../assets/image/t-1.png');
    ...
    .intro_text__headline::before{
        content: "";
        position: absolute;
        inset: 0;
        border: 2px solid #2fa7e3;
